...
<acme:form>
	...
	<acme:form-textarea code="authenticated.overture.form.label.body" path="body"/>
	<acme:form-money code="authenticated.overture.form.label.money-min" path="moneyMin"/>
	<acme:form-money code="authenticated.overture.form.label.money-max" path="moneyMax"/>
