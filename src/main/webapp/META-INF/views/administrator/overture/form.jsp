...
<acme:form>
	...
	<acme:form-money code="administrator.overture.form.label.money-min" path="moneyMin"/>
	<acme:form-money code="administrator.overture.form.label.money-max" path="moneyMax"/>
